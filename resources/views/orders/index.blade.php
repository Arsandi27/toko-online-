<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Riwayat Pesanan</h2>
    </x-slot>
            ...
            <div class="bg-white shadow sm:rounded-lg">
                <div class="divide-y divide-gray-100">
                    @forelse ($orders as $order)
                        <a href="{{ route('orders.show', $order) }}" class="grid grid-cols-1 gap-2 p-6 hover:bg-gray-50 md:grid-cols-4 md:items-center">
                            <div>
